...
class Statskeeper(object):
    ...
    def uptime(self):
        """uptime since we started postomaat"""
    ...
    def increasecounters(self, suspect):
        ...
        delta.scantime = suspect.get_tag('postomaat.scantime')
...
class StatsThread(object):
    ...
    def __init__(self, config):
        ...
        self.logger = logging.getLogger('postomaat.stats')
        self.writeinterval = 30
        self.identifier = 'postomaat'
        self.stayalive = True
